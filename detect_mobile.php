...
change log
25.11.08 added kindle to pipe seperated array
27.11.08 added support for blackberry devices to be redirected to url
*/
...
#  if(preg_match('/Sunrise/', $accept)) return true;
